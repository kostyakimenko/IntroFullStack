    ...
    $.ajax(request).done(function(response) {
        switch (response.status) {
            case 'success':
                ...
                break;
            case 'user_error':
                showError(user, response.message);
                break;
            case 'pass_error':
                showError(pass, response.message);
                break;
            case 'db_error':
                showError($('.auth__btn'), response.message);
                break;
        }

        logging('authorization', response)
    })
});
...
chatForm.on('submit', function(event) {
    ...
    $.ajax(request).done(function(response) {
        switch (response.status) {
            ...
            case 'msg_error':
            case 'db_error':
                showError(chatForm, response.message);
                break;
        }
...
function logging(service, response) {
    console.log({
